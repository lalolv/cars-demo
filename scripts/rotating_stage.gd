...
@export var auto_play_car_animation: bool = true
...
func _play_car_animation(car_root: Node) -> void:
	if not auto_play_car_animation:
		return

	var animation_players: Array[AnimationPlayer] = []
	_collect_animation_players(car_root, animation_players)
